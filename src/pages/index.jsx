...
export default () => (
  <Layout>
    ...
    >
      ...
      <PrivateRoute
        path="/events/:event/teams"
        component={EventTeams}
        type={2}
      />
      <PrivateRoute
        path="/events/:event/teams/:college/:team"
        component={EventParticipants}
        type={2}
      />
      <PrivateRoute
        path="/events/:event/rounds"
        exact
        component={Rounds}
        type={2}
      />
      <PrivateRoute
        path="/events/:event/rounds/add"
        exact
        component={AddEditRound}
        type={1}
      />
      <PrivateRoute
        path="/events/:event/rounds/:round/slot"
        exact
        component={Slots}
        type={2}
      />
      <PrivateRoute
        path="/events/:event/rounds/:round/edit"
        exact
        component={AddEditRound}
        type={1}
      />
      <PrivateRoute
        path="/events/:event/rounds/:round/leaderboard"
        exact
        component={RoundLeaderboard}
        type={1}
      />
      <PrivateRoute
        path="/events/:event/rounds/:round/bias"
        exact
        component={Bias}
        type={1}
      />
      ...
      />
      <PrivateRoute
        path="/events/:event/rounds/:round/leaderboard/download"
        exact
        component={Download}
        type={2}
      />
      ...
      <PrivateRoute
        path="/colleges/:college/edit"
        component={EditCollege}
        type={1}
      />
      <PrivateRoute
        path="/colleges/:college/teams"
        component={Teams}
        type={2}
      />
      <PrivateRoute
        path="/colleges/:college/teams/:team/members"
        component={Members}
        type={1}
      />
      ...
      <PrivateRoute
        path="/judge/:event/rounds/:round"
        exact
        component={Judge}
        type={2}
      />
      <PrivateRoute
        path="/events/:event/rounds/:round/scoresheet"
        exact
        component={ViewJudgeSheet}
        type={2}
      />
      ...
      <PrivateRoute
        path="/teams/members/:member/edit"
      ...
      />
      <PrivateRoute
        path="/register/:event/teams"
        component={RegisterTeam}
        type={8}
      />
      <PrivateRoute
        path="/register/:event/teams/:team"
        component={Participants}
        type={8}
      />
      <PrivateRoute
        path="/register/:event/teams/:team/update"
      ...
      <PrivateRoute
        path="/volunteers/core"
        component={CoreVolunteer}
        type={1 << 3}
      />
      <PrivateRoute
        path="/volunteers/core/:volunteerId"
        component={CoreVolunteerEdit}
        type={1 << 3}
      />
      <PrivateRoute
        path="/volunteers/:type"
        component={Volunteer}
        type={1 << 3}
      />
      <PrivateRoute
        path="/volunteers/:type/:volunteerId"
      ...
      <PrivateRoute
        path="/practice-slots/public"
        component={PublicPracticeSlots}
        type={8}
      />
