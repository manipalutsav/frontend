    ...
    <>
      ...
      >
        <StatsCard
          ...
          meta={
            'From ' +
            (this.state.stats.colleges && this.state.stats.colleges.locations) +
            ' locations'
          }
        />
        <StatsCard
          ...
          meta={
            'In ' +
            (this.state.stats.events && this.state.stats.events.venues) +
            ' venues'
          }
        />
        <StatsCard
          ...
          meta={
            (this.state.stats.participants &&
              this.state.stats.participants.staff) + ' participanting staff'
          }
        />
        <StatsCard
          ...
          count={
            this.state.stats.participants &&
            this.state.stats.participants.total -
              this.state.stats.participants.staff
          }
        ...
        />
        <StatsCard name="Days" count="6" meta="2 day for staff" />
      </div>
    </>
  );
}
